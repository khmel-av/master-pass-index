...
public class UserController {
  ...
  public UserDto getCurrentUser(@AuthenticationPrincipal final User user) {
  ...
  public UserDto getUser(@PathVariable("userId") long userId) {
    return this.userService.getUser(this.userService.getUser(userId));
  }
  ...
  @RequestMapping(value = "/public/token", method= {POST})
  public String getToken(@Valid @RequestBody AuthDto authDto) throws ValidationException {
    String token = this.userService.getToken(authDto);
